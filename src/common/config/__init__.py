...
class GroupConfig(Config):
    ...
    def debug_mode(self) -> bool:
        ...
        '''
        mode = self._find('debug_mode')
        return mode if mode else plugin_config.default_debug_mode

    def set_debug_mode(self, mode: bool) -> None:
        '''
        设置调试模式

        :param mode: False 关闭 True 开启
        '''
        self._update('debug_mode', mode)
    ...
    def roulette_mode(self) -> int:
        ...
        return mode if mode is not None else plugin_config.default_roulette_mode
